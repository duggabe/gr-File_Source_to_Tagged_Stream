...
class FStTS(gr.sync_block):
    def __init__(self, FileName='None', Pkt_len=384, Preamble_len=64, Postamble_len=16):
    ...
    def work(self, input_items, output_items):
        ...
        if (self.state == 0):
            ...
            while (i < self.c_len):
                ...
                i += 1
            self.pre_count += 1
            if (self.pre_count >= self.Preamble_len):    # number of preamble packets
                self.pre_count = 0
            ...
            while (i < self.f_len):
                ...
                i += 1
            self.pre_count += 1
            if (self.pre_count >= self.Postamble_len):   # number of postamble packets
                self.pre_count = 0
                self.state = 0      # idle
            return (self.f_len)
